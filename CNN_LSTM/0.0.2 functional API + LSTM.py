...
# pickle.dump(tokenizer, open('../saved_models/tokenizer.007.p', 'wb'))
...
# x = Conv1D(nb_filter=128, filter_length=5, activation='relu')(embedded_sequences)
...
# x = LSTM(100, dropout_W=0.2, dropout_U=0.2)(x)
# x = Flatten()(x)
...
print("Accuracy of Model on val: %.2f%%" % (scores[1]*100))
...
#  Mar 23, 2017 Accuracy of Disk-Loaded Model: 77.54%
#  w/o dropout: Accuracy of Disk-Loaded Model: 47.04%
#  w/ LSTM(128) Accuracy of Disk-Loaded Model: 72.59%
#  w/ dropout:  Accuracy of Disk-Loaded Model: 91.80%

# Apr 10, 2017
#  1 Conv1D to LSTM  Accuracy of Model on val: 37.81%
#  LSTM alone Accuracy:                        26.21%
#  Single dense activation layer Accuracy:     40.26%
#  3x Conv1D to LSTM Accuracy of Model on val: 72.17%
